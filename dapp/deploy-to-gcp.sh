...
# Multi-Region Deployment Script for NexusWealth DApp (app.nwis.io)
# Deploys to US, Europe, and Asia for global low-latency access

# Configuration
PROJECT_ID="nexuswealthtest"
SERVICE_NAME="nexuswealth-dapp-v2"  # Different service name from main site
REGIONS=("us-central1" "europe-west1" "asia-southeast1")
IMAGE_NAME="gcr.io/$PROJECT_ID/$SERVICE_NAME"

echo "🌍 Starting multi-region deployment for app.nwis.io..."
...
echo "================================================"
echo ""
echo "📊 Deployment Summary (app.nwis.io):"
for region in "${REGIONS[@]}"; do
    SERVICE_URL=$(gcloud run services describe $SERVICE_NAME \
        --platform managed \
        --region $region \
...
echo ""
echo "✅ Your dapp is now running globally!"
echo "✅ Main site (nwis.io) remains unchanged"
echo ""
