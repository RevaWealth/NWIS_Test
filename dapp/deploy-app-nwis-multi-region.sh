...
# Multi-Region Deployment Script for app.nwis.io
# Deploys NexusWealth dApp to 3 Google Cloud Run regions
...
echo "   2. Configure DNS to point to the load balancer"
