...
module.exports = async function (deployer, network, accounts) {
  ...
  console.log("💰 Account balance:", (await web3.eth.getBalance(accounts[0])).toString());
  ...
  try {
    ...
    const deploymentInfo = {
      ...
      contracts: {
        ...
        NexusWealthPresale: presale.address
      },
      deployer: accounts[0],
      parameters: {
        ...
        totalTokensForSale: web3.utils.fromWei(totalTokensForSale, "ether"),
        minPurchase: web3.utils.fromWei(minPurchase, "ether"),
        maxPurchase: web3.utils.fromWei(maxPurchase, "ether")
      },
