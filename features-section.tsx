...
export default function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-20 bg-[#070b14] text-white bg-white">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-[#0c1220] p-8 rounded-xl border border-gray-800 shadow-lg flex flex-col items-center text-center transition-transform transform hover:scale-105 hover:shadow-2xl bg-sky-950"
            >
